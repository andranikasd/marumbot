...
var catalogue = map[Locale]map[string]string{
	HY: {
		...
		"tip.add":                "Ավելացրեք առաջին վարկը («➕ Ավելացնել վարկ»)․ ես կարող եմ պլանավորել միայն այն, ինչ տեսնում եմ։",
		...
		"advice.month_total": "Ընդամենը՝ <code>%s</code> · ամսվա վերջում կմնա <code>%s</code>",
		"advice.finish":      "🏁 Ավարտ՝ <b>%s</b> (%d ամիս)",
		"advice.cost":        "💸 Ընդհանուր տոկոս՝ <code>%s</code>",
	...
	EN: {
		...
		// --- the journey: one tip per message, the next thing worth doing ---
		"tip.add":                "Add your first loan (➕ Add a loan): I can only plan what I can see.",
		...
		"advice.month_total": "Total <code>%s</code> · <code>%s</code> left owing after this month",
		"advice.finish":      "🏁 Done <b>%s</b> (%d months)",
		"advice.cost":        "💸 Total interest <code>%s</code>",
