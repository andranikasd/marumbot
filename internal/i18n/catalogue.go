...
var catalogue = map[Locale]map[string]string{
	HY: {
		...
		// --- greeting ---
		"start.greeting": "Մարման հստակ պլան՝ ձեր թվերով․ ում, երբ և որքան վճարել, որ տոկոսն ամենաքիչը լինի։",
		"start.next":     "Սկսենք՝ սեղմեք «Բացել Մարումը» և ավելացրեք առաջին վարկը։",
		"start.language": "Prefer English? Send /language.",
		...
		"btn.dashboard":  "Բացել Մարումը",
		"btn.advice":     "Ի՞նչ անել",
		"btn.loans":      "Իմ վարկերը",
		"btn.budget":     "Բյուջե",
		"btn.language":   "Լեզուն",
		"btn.help":       "Ինչպես է աշխատում",
		"btn.plan":       "Տեսնել պլանը",
		"btn.manage":     "Կառավարել վարկերը",
		"kb.placeholder": "Ընտրեք գործողություն",
		// --- the journey: one tip per message, the next thing worth doing ---
		"tip.add":                "Ավելացրեք առաջին վարկը («Բացել Մարումը»)․ ես կարող եմ պլանավորել միայն այն, ինչ տեսնում եմ։",
		...
		"tip.pro.compare":        "«Համեմատել»-ը ցույց է տալիս բոլոր նպատակները կողք կողքի՝ գնով ու ժամկետով։",
		...
		"tip.pro.update_balance": "Վաղաժամկետ մարումից հետո թարմացրեք մնացորդը («Կառավարել վարկերը»)․ պլանը կհետևի։",
		...
		"help.compare":           "<b>Համեմատել</b> — բոլոր նպատակները կողք կողքի, գնով ու ժամկետով։",
		...
		"advice.why_button":   "Ինչու այս պլանը",
		"plan.approve_button": "Հաստատել այս պլանը",
		"plan.sheet_button":   "Բացել ամբողջ պլանը",
		...
		"advice.compare":       "Համեմատել տարբերակները",
		"advice.compare_title": "Համեմատություն",
		...
		"paid.skip_button":    "Բաց թողնել առայժմ",
		...
		"paid.cleared":        "«%s»-ի զրոյական մնացորդը գրանցված է։ Վարկի փակումը ճշտեք բանկի հետ։",
		...
		"fig.next":                "Հաջորդը",
		"fig.debtfree":            "Ազատ պարտքից",
		"fig.monthly":             "Ամեն ամիս",
		"fig.saved":               "Խնայված տոկոս",
		"fig.sooner":              "Ավելի շուտ",
		"fig.months":              "%d ամիս",
		"fig.balance":             "Մնացորդ",
		"fig.interest":            "Վճարվելիք տոկոս",
		"loan.line":               "%s, %s%%, հաջորդը %s",
		"reminder.title":          "Վճարում %s-ին",
		"payment.record":          "Գրանցել վճարումը",
		"payment.prompt":          "«%s»․ գրանցեք վճարված գումարը և բանկի գրանցման կարգավիճակը։ Marum-ը գումար չի փոխանցում։",
		"payment.reconcile":       "Վճարման գրառումը պահանջում է համադրում։ Բացեք պատմությունը՝ գրառումը ստուգելու համար։",
		"paid.title":              "Թարմացնել մնացորդը",
		"paid.updated":            "Մնացորդը թարմացված է",
		"advice.extra_line":       "Հավելյալը վճարվում է աշխատավարձի օրը և խնայում է %s տոկոս",
		"advice.extra_line_plain": "Հավելյալը վճարվում է պարտադիրից բացի։",
	},
	...
	EN: {
		...
		"start.greeting":      "A repayment plan built from your own numbers: whom to pay, when, and how much, so you pay the least interest.",
		"start.next":          "Start by tapping Open Marum and adding your first loan.",
		"start.language":      "Հայերե՞ն — ուղարկեք /language։",
		...
		"btn.manage":     "Manage loans",
		"kb.placeholder": "Choose an action",
		// --- the journey: one tip per message, the next thing worth doing ---
		"tip.add":                "Add your first loan (Open Marum): I can only plan what I can see.",
		...
		"tip.pro.compare":        "Compare shows every goal side by side, with its cost and finish date.",
		...
		"tip.pro.update_balance": "After an early repayment, update the balance (Manage loans): the plan will follow.",
		...
		"help.compare":           "<b>Compare</b> — every goal side by side, with its cost and finish date.",
		...
		"advice.why_button":   "Why this plan",
		"plan.approve_button": "Approve this plan",
		"plan.sheet_button":   "Open full plan",
		...
		"advice.compare":       "Compare strategies",
		"advice.compare_title": "Comparison",
		"advice.row":           "<code> %s · %s</code>",
		...
		"paid.cleared":        "Zero balance recorded for “%s”. Confirm the loan’s closure with your bank.",
		...
		"fig.next":                "Next",
		"fig.debtfree":            "Debt-free",
		"fig.monthly":             "Every month",
		"fig.saved":               "Interest saved",
		"fig.sooner":              "Sooner",
		"fig.months":              "%d months",
		"fig.balance":             "Balance",
		"fig.interest":            "Interest to pay",
		"loan.line":               "%s, %s%%, next %s",
		"reminder.title":          "Payment due %s",
		"payment.record":          "Quick Record",
		"payment.prompt":          "“%s”: record the amount you paid and its bank posting status. Marum does not transfer money.",
		"payment.reconcile":       "A payment needs reconciliation. Open Activity to review the record before planning further payments.",
		"paid.title":              "Update balance",
		"paid.updated":            "Balance updated",
		"advice.extra_line":       "Extra paid on payday; it saves %s of interest in the month ahead",
		"advice.extra_line_plain": "The extra is paid beyond the instalments.",
	},
}
