...
addStrings({
 'prefs.title':'Հիշեցումների կարգավորումներ','prefs.zone':'Ժամային գոտի','prefs.quiet':'Լուռ ժամեր','prefs.start':'Սկիզբ','prefs.end':'Ավարտ','prefs.required':'Միացված հիշեցումները լուռ ժամերին սպասում են։','prefs.save':'Պահպանել','prefs.saved':'Պահպանված է','prefs.error':'Պահպանումը հաստատված չէ։ Կրկին փորձեք։','prefs.invalid':'Ստուգեք ժամային գոտին և լուռ ժամերը։','prefs.conflict':'Կարգավորումները փոխվել են։ Վերաբացեք էջը։'
},{
 'prefs.title':'Reminder settings','prefs.zone':'Timezone','prefs.quiet':'Quiet hours','prefs.start':'Start','prefs.end':'End','prefs.required':'When reminders are enabled, delivery waits during quiet hours.','prefs.save':'Save settings','prefs.saved':'Saved','prefs.error':'Save unconfirmed. Retry to check the same request.','prefs.invalid':'Check the timezone and quiet hours.','prefs.conflict':'Settings changed. Reopen this page.'
});
